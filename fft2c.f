...
!warning for IWK index out of bounds, accually it is fine
!subroutine of fortran passes address of array not the value
!incomming IWK(534) and receiver WK(1) have the same address
!change IWK(1) to IWK(534) or IWK(7)
!liang 2022.6.27
      INTEGER            M,IWK(7)  !IWK(1)
      COMPLEX            A(1)
